...
from fastapi import FastAPI, WebSocket, WebSocketDisconnect, Request, Response, Header, HTTPException, status
...
async def upload_init(payload: InitUploadRequest):
    """
...
async def upload_complete(transfer_id: str):
    """
...
async def download_meta(file_id: str):
